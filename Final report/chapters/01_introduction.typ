...
Magnetic Resonance Imaging (MRI) has emerged as the gold standard for neuro-oncological assessment, offering sub-millimetre volumetric resolution essential for characterising the three clinically distinct tumour sub-regions defined by the Brain Tumour Segmentation (BraTS) challenge: the Whole Tumour (WT), encompassing all pathological tissue; the Tumour Core (TC), comprising necrotic and actively proliferating regions; and the Enhancing Tumour (ET), the contrast-enhancing rim that directly governs radiotherapy dose planning and surgical margin delineation @6975210. Manual delineation of these boundaries from multi-modal MRI across T1-weighted, contrast-enhanced T1 (T1ce), T2-weighted, and FLAIR sequences remains a labour-intensive, subjective, and anatomically demanding task. Inter-rater variability in expert manual segmentation has been documented at up to 28% for the ET sub-region @neri2023, which carries the highest clinical consequence given its role in defining treatment targets. This variability, compounded by the cognitive burden of mentally reconstructing three-dimensional pathology from sequential two-dimensional slices, renders the case for automated, precise volumetric segmentation both urgent and unambiguous.
